...
public class dish extends Activity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cursor= db.rawQuery("SELECT _id,d_dishname,d_date from dish", null);
        adapter = new SimpleCursorAdapter(this, R.layout.dishlist, cursor, new String[]{"d_dishname","d_date"},new int[]{R.id.di_name, R.id.di_date});
        ...
        dishview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                try {
                    ...
                    bundle3.putString("idf1",c2.getString(7));
                    bundle3.putString("f2", c2.getString(8));
                    bundle3.putString("qf2",c2.getString(9));
                    bundle3.putString("uf2",c2.getString(10));
                    bundle3.putString("idf2",c2.getString(11));
                    bundle3.putString("f3", c2.getString(12));
                    bundle3.putString("qf3",c2.getString(13));
                    bundle3.putString("uf3",c2.getString(14));
                    bundle3.putString("idf3",c2.getString(15));
                    bundle3.putString("f4", c2.getString(16));
                    bundle3.putString("qf4",c2.getString(17));
                    bundle3.putString("uf4",c2.getString(18));
                    bundle3.putString("idf4",c2.getString(19));
                    bundle3.putString("f5", c2.getString(20));
                    bundle3.putString("qf5",c2.getString(21));
                    bundle3.putString("uf5", c2.getString(22));
                    bundle3.putString("idf5",c2.getString(23));
                    bundle3.putString("f6", c2.getString(24));
                    bundle3.putString("qf6",c2.getString(25));
                    bundle3.putString("uf6",c2.getString(26));
                    bundle3.putString("idf6",c2.getString(27));
                    bundle3.putString("f7", c2.getString(28));
                    bundle3.putString("qf7",c2.getString(29));
                    bundle3.putString("uf7",c2.getString(30));
                    bundle3.putString("idf7",c2.getString(31));
                    bundle3.putString("f8", c2.getString(32));
                    bundle3.putString("qf8",c2.getString(33));
                    bundle3.putString("uf8",c2.getString(34));
                    bundle3.putString("idf8",c2.getString(35));
                    bundle3.putString("f9", c2.getString(36));
                    bundle3.putString("qf9",c2.getString(37));
                    bundle3.putString("uf9",c2.getString(38));
                    bundle3.putString("idf9",c2.getString(39));
                    bundle3.putString("date",c2.getString(40));
